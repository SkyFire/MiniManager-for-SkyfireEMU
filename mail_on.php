...
function do_search()
{
    ...
    $query = $sql->query("SELECT a.id, a.messageType, a.sender, a.receiver, a.subject, a.body, a.has_items, a.money, a.cod, a.checked, c.itemEntry
                          FROM (mail a INNER JOIN mail_items b ON a.id = b.mail_id) INNER JOIN item_instance c ON c.guid = b.item_guid ORDER BY $order_by $order_dir LIMIT $start, $itemperpage");
...
function search() {
    ...
    $query = $sql->query("SELECT a.id, a.messageType, a.sender, a.receiver, a.subject, a.body, a.has_items, a.money, a.cod, a.checked, c.itemEntry
                            ...
                            INNER JOIN item_instance c ON c.guid = b.item_guid
